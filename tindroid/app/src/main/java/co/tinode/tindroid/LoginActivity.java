...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isSignUp = ((TindroidApp) getApplication()).SignUpNeeded();
        ((TindroidApp) getApplication()).setSignUpNeeded(false);
        phonenumber = ((TindroidApp) getApplication()).Phonenumber();
        ...
        if (isSignUp)
        {
            showFragment(FRAGMENT_SIGNUP, null, false);
        }
        else {
