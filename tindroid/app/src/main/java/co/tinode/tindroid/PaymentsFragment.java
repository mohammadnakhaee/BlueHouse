...
import static co.tinode.tindroid.UiUtils.getContactName;
...
public class PaymentsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstance) {
        ...
        view.findViewById(R.id.uploadAvatar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UiUtils.requestAvatar(PaymentsFragment.this);
            }
        });
    ...
    private static class MemberViewHolder extends RecyclerView.ViewHolder {
        ...
        MemberViewHolder(View item) {
            ...
            m1 = item.findViewById(R.id.m_1);
            m2 = item.findViewById(R.id.m_2);
            m3 = item.findViewById(R.id.m_3);
            m4 = item.findViewById(R.id.m_4);
            m5 = item.findViewById(R.id.m_5);
            m6 = item.findViewById(R.id.m_6);
            m7 = item.findViewById(R.id.m_7);
            m8 = item.findViewById(R.id.m_8);
            m9 = item.findViewById(R.id.m_9);
            m10 = item.findViewById(R.id.m_10);
            m11 = item.findViewById(R.id.m_11);
            m12 = item.findViewById(R.id.m_12);
        }
    }
        ...
        public void onBindViewHolder(@NonNull final MemberViewHolder holder, int position) {
            ...
            if (sub.pub != null) {
                if (title == null) {
                    ...
                    try {
                        String UserPhoneNumber = sub.pub.fn;
                        String LocalName = getContactName(activity.getApplicationContext(), UserPhoneNumber);
            ...
            holder.extraInfo.setText("1399");

            holder.m1.setBackgroundColor(Color.parseColor("#007700"));
            holder.m2.setBackgroundColor(Color.parseColor("#007700"));
            holder.m3.setBackgroundColor(Color.parseColor("#007700"));
            holder.m4.setBackgroundColor(Color.parseColor("#007700"));
            if (sub.pub.fn.equals("+001"))
            {
                holder.m5.setBackgroundColor(Color.parseColor("#4790c8"));
            }

            if (sub.pub.fn.equals("+002"))
            {
                holder.m5.setBackgroundColor(Color.parseColor("#4790c8"));
                holder.m6.setBackgroundColor(Color.parseColor("#4790c8"));
            }

            if (sub.pub.fn.equals("+989124101723"))
            {
                holder.m5.setBackgroundColor(Color.parseColor("#4790c8"));
                holder.m6.setBackgroundColor(Color.parseColor("#4790c8"));
                holder.m7.setBackgroundColor(Color.parseColor("#4790c8"));
                holder.m8.setBackgroundColor(Color.parseColor("#4790c8"));
            }

            if (sub.pub.fn.equals("+004"))
            {
                holder.m5.setBackgroundColor(Color.parseColor("#4790c8"));
                holder.m6.setBackgroundColor(Color.parseColor("#4790c8"));
            }
