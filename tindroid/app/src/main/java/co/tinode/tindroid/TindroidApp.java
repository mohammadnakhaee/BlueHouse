...
public class TindroidApp extends Application implements LifecycleObserver {
    ...
    public boolean getIsUserReady() {
        return isUserReady;
    }
    public void setIsUserReady(boolean isReady) {
        this.isUserReady = isReady;
    }

    private boolean isSignUpNeeded;
    public boolean SignUpNeeded() {
        return isSignUpNeeded;
    }
    public void setSignUpNeeded(boolean isSignUpNeeded) {
        this.isSignUpNeeded = isSignUpNeeded;
    }
    ...
    private String theValidationToken;
    public String ValidationToken() {
        return theValidationToken;
    }
    public void setValidationToken(String theValidationToken) {
        this.theValidationToken = theValidationToken;
    }
    ...
    public void setLastPage(int theLastPage) {
    ...
    public static String getDefaultHostName(Context context) {
        return context.getResources().getString(R.string.test_host_name);
