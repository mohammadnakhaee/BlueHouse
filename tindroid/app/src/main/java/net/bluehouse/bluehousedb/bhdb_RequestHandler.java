...
public class bhdb_RequestHandler {
    ...
    public String sendPostRequest(String requestURL, HashMap<String, String> postDataParams, HashMap<String, String> Header) {
        URL url;
    ...
    public String sendPostRequest(String requestURL, HashMap<String, String> postDataParams, HashMap<String, String> Header, String BearerAccessToken) {
        URL url;
